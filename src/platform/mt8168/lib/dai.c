...
static int afe_dai_handshake[MT8168_DAI_NUM] = {
	// AFE_HANDSHAKE(MT8168_AFE_IO_I2S_2CH_DAC, MT8168_AFE_IRQ_1, MT8168_MEMIF_DL1),
	// AFE_HANDSHAKE(MT8168_AFE_IO_I2S_2CH_2ND, MT8168_AFE_IRQ_2, MT8168_MEMIF_DL2),
	// AFE_HANDSHAKE(MT8168_AFE_IO_UL_SRC1, MT8168_AFE_IRQ_3, MT8168_MEMIF_AWB),
	// AFE_HANDSHAKE(MT8168_AFE_IO_DMIC_0_1, MT8168_AFE_IRQ_4, MT8168_MEMIF_VUL),
	AFE_HANDSHAKE(MT8168_AFE_IO_INT_ADDA_OUT, MT8168_AFE_IRQ_1, MT8168_MEMIF_DL1),
	AFE_HANDSHAKE(MT8168_AFE_IO_2ND_I2S, MT8168_AFE_IRQ_2, MT8168_MEMIF_DL2),
	AFE_HANDSHAKE(MT8168_AFE_IO_INT_ADDA_IN, MT8168_AFE_IRQ_3, MT8168_MEMIF_AWB),
	AFE_HANDSHAKE(MT8168_AFE_IO_DMIC, MT8168_AFE_IRQ_4, MT8168_MEMIF_VUL),
};

static SHARED_DATA struct dai afe_dai[MT8168_DAI_NUM];
